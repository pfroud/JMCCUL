 ...
 *
 * @see <a href="https://www.mccdaq.com/pdfs/manuals/Mcculw_WebHelp/hh_goto.htm?ULStart.htm#Function_Reference/Device-Discovery/DaqDeviceDescriptor-type.htm">DaqDeviceDescriptor</a>
 */
public class DaqDeviceDescriptor extends Structure {
    ...
    /**
     * A character array associated with the detected device.
     * For Ethernet devices, this value represents a NetBIOS name.
     * This value may be the same as the ProductName on some devices,
     * but may contain more specific information on other devices.
     */
    public byte[] DevString = new byte[64];

    /**
     * A string identifier that indicates the serial number of a detected USB device,
     * or the MAC address of a detected Bluetooth or Ethernet device.
     */
